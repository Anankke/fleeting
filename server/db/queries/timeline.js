...
/**
 * Upsert a 30s timeline bucket, averaging with existing data if present.
 */
...
/**
 * Return all 30s timeline buckets for a fleet, grouped by pilot.
 */
async function getForFleet(fleetSessionId) {
...
module.exports = { upsert, getForFleet };
